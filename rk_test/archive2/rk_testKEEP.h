...
#define rk_expect_stdouteq(errstr, len)       RK_EXPECT(RKTf_streameq, RKTF_STDOUTEQ, "stdouteq(" #errstr ")", RK_OUTPUTSTREAMS_STDOUT, errstr, len)
#define rk_expect_stdoutneq(errstr, len)      RK_EXPECT(RKTf_streamneq, RKTF_STDOUTNEQ, "stdoutneq(" #errstr ")",  RK_OUTPUTSTREAMS_STDOUT, errstr, len)
#define rk_expect_stderreq(errstr, len)       RK_EXPECT(RKTf_streameq, RKTF_STDERREQ, "stderreq(" #errstr ")", RK_OUTPUTSTREAMS_STDERR, errstr, len)
#define rk_expect_stderrneq(errstr, len)      RK_EXPECT(RKTf_streamneq, RKTF_STDERRNEQ, "stderrneq(" #errstr ")",  RK_OUTPUTSTREAMS_STDERR, errstr, len)
...
#define rk_assert_stdouteq(errstr, len)       RK_ASSERT(RKTf_streameq, RKTF_STDOUTEQ, "stdouteq(" #errstr ")", RK_OUTPUTSTREAMS_STDOUT, errstr, len)
#define rk_assert_stdoutneq(errstr, len)      RK_ASSERT(RKTf_streamneq, RKTF_STDOUTNEQ, "stdoutneq(" #errstr ")", RK_OUTPUTSTREAMS_STDOUT, errstr, len)
#define rk_assert_stderreq(errstr, len)       RK_ASSERT(RKTf_streameq, RKTF_STDERREQ, "stderreq(" #errstr ")", RK_OUTPUTSTREAMS_STDERR, errstr, len)
#define rk_assert_stderrneq(errstr, len)      RK_ASSERT(RKTf_streamneq, RKTF_STDERRNEQ, "stderrneq(" #errstr ")", RK_OUTPUTSTREAMS_STDERR, errstr, len)
