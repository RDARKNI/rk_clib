...
// clang-format off
#define rk_expect_true(EXPR_)                 RKT_EXPECT(RKTf_true, RKTF_TRUE, "expect_true("#EXPR_")", EXPR_)
#define rk_expect_false(EXPR_)                RKT_EXPECT(RKTf_false, RKTF_FALSE, "expect_false("#EXPR_")", EXPR_)
#define rk_expect_null(PTR_)                  RKT_EXPECT(RKTf_null, RKTF_NULL, "expect_null("#PTR_")", PTR_)
#define rk_expect_nonnull(PTR_)               RKT_EXPECT(RKTf_nnull, RKTF_NNULL, "expect_nonnull("#PTR_")", PTR_)
#define rk_expect_memeq(ptr1, ptr2, siz)      RKT_EXPECT(RKTf_memeq, RKTF_MEMEQ, "expect_memeq(" #ptr1 ", " #ptr2 ", " #siz ")", ptr1, ptr2, siz)
#define rk_expect_memneq(ptr1, ptr2, siz)     RKT_EXPECT(RKTf_memneq, RKTF_MEMNEQ, "expect_memneq(" #ptr1 ", " #ptr2 ", " #siz ")", ptr1, ptr2, siz)
#define rk_expect_memzero(ptr, siz)           RKT_EXPECT(RKTf_memzero, RKTF_MEMZERO, "expect_memzero(" #ptr ",  " #siz ")", ptr, siz)
#define rk_expect_memnzero(ptr, siz)          RKT_EXPECT(RKTf_memnzero, RKTF_MEMNZERO, "expect_memnzero(" #ptr ",  " #siz ")", ptr, siz)
#define rk_expect_eq(exp, act)                RKT_EXPECT(RKT_SELFUN(eq, exp), RKTF_EQ, "expect_eq("#exp", " #act")", exp, act)
#define rk_expect_neq(exp, act)               RKT_EXPECT(RKT_SELFUN(neq, exp), RKTF_NEQ, "expect_neq("#exp", " #act")", exp, act)
#define rk_expect_lt(exp, act)                RKT_EXPECT(RKT_SELFUN(eq, exp), RKTF_LT, "expect_lt("#exp", " #act")", exp, act)
#define rk_expect_leq(exp, act)               RKT_EXPECT(RKT_SELFUN(neq, exp), RKTF_LEQ, "expect_leq("#exp", " #act")", exp, act)
#define rk_expect_gt(exp, act)                RKT_EXPECT(RKT_SELFUN(eq, exp), RKTF_GT, "expect_gt("#exp", " #act")", exp, act)
#define rk_expect_geq(exp, act)               RKT_EXPECT(RKT_SELFUN(neq, exp), RKTF_GEQ, "expect_geq("#exp", " #act")", exp, act)
#define rk_expect_inrange(val, low, high)     RKT_EXPECT(RKT_SELFUN(inrange, val), RKTF_INRANGE, "expect_inrange(" #val ", " #low", " #high ")", val, low, high)
#define rk_expect_floateq_tol(exp, act, tol)  RKT_EXPECT(RKT_SELFUN_TOL(toleq, exp), RKTF_TOLEQ, "expect_floateq_tol("#exp", " #act ", " #tol ")", exp, act, tol)
#define rk_expect_floatneq_tol(exp, act, tol) RKT_EXPECT(RKT_SELFUN_TOL(tolneq, exp), RKTF_TOLNEQ,  "expect_floatneq_tol("#exp", " #act ", " #tol ")", exp, act, tol)
#define rk_expect_streq(str1, str2)           RKT_EXPECT(RKTf_streq, RKTF_STREQ, "expect_streq(" #str1 ", " #str2 ")", str1, str2)
#define rk_expect_strneq(str1, str2)          RKT_EXPECT(RKTf_strneq, RKTF_STRNEQ,"expect_strneq(" #str1 ", " #str2 ")", str1, str2)                                    
#define rk_expect_streq_n(str1, str2, len)    RKT_EXPECT(RKTf_streq_n, RKTF_STREQ, "expect_streq(" #str1 ", " #str2 ", " #len")", str1, str2, len)
#define rk_expect_strneq_n(str1, str2, len)   RKT_EXPECT(RKTf_strneq_n, RKTF_STRNEQ,"expect_strneq(" #str1 ", " #str2 ", " #len")", str1, str2, len)  
#define rk_expect_stdouteq(errstr, len)       RKT_EXPECT(RKTf_streameq, RKTF_STDOUTEQ, "expect_stdouteq(" #errstr ")", RK_OUTPUTSTREAMS_STDOUT, errstr, len)
#define rk_expect_stdoutneq(errstr, len)      RKT_EXPECT(RKTf_streamneq, RKTF_STDOUTNEQ, "expect_stdoutneq(" #errstr ")",  RK_OUTPUTSTREAMS_STDOUT, errstr, len)
#define rk_expect_stderreq(errstr, len)       RKT_EXPECT(RKTf_streameq, RKTF_STDERREQ, "expect_stderreq(" #errstr ")", RK_OUTPUTSTREAMS_STDERR, errstr, len)
#define rk_expect_stderrneq(errstr, len)      RKT_EXPECT(RKTf_streamneq, RKTF_STDERRNEQ, "expect_stderrneq(" #errstr ")",  RK_OUTPUTSTREAMS_STDERR, errstr, len)


#define rk_assert_true(expr)                  RKT_ASSERT(RKTf_true, RKTF_TRUE, "assert_true("#expr")", expr)
#define rk_assert_false(expr)                 RKT_ASSERT(RKTf_false, RKTF_FALSE, "assert_false("#expr")", expr)
#define rk_assert_null(ptr)                   RKT_ASSERT(RKTf_null, RKTF_NULL, "assert_null("#ptr")", ptr)
#define rk_assert_nonnull(ptr)                RKT_ASSERT(RKTf_nnull, RKTF_NNULL, "assert_nonnull("#ptr")", ptr)
#define rk_assert_memeq(ptr1, ptr2, siz)      RKT_ASSERT(RKTf_memeq, RKTF_MEMEQ, "assert_memeq(" #ptr1 ", " #ptr2 ", " #siz ")", ptr1, ptr2, siz)
#define rk_assert_memneq(ptr1, ptr2, siz)     RKT_ASSERT(RKTf_memneq, RKTF_MEMNEQ, "assert_memneq(" #ptr1 ", " #ptr2 ", " #siz ")", ptr1, ptr2, siz)
#define rk_assert_memzero(ptr, siz)           RKT_ASSERT(RKTf_memzero, RKTF_MEMZERO, "assert_memzero(" #ptr ",  " #siz ")", ptr, siz)
#define rk_assert_memnzero(ptr, siz)          RKT_ASSERT(RKTf_memnzero, RKTF_MEMNZERO, "assert_memnzero(" #ptr ",  " #siz ")", ptr, siz)
#define rk_assert_eq(exp, act)                RKT_ASSERT(RKT_SELFUN(eq, exp), RKTF_EQ, "assert_eq("#exp", " #act")", exp, act)
#define rk_assert_neq(exp, act)               RKT_ASSERT(RKT_SELFUN(neq, exp), RKTF_NEQ, "assert_neq("#exp", " #act")", exp, act)
#define rk_assert_lt(exp, act)                RKT_ASSERT(RKT_SELFUN(eq, exp), RKTF_LT, "assert_lt("#exp", " #act")", exp, act)
#define rk_assert_leq(exp, act)               RKT_ASSERT(RKT_SELFUN(neq, exp), RKTF_LEQ, "assert_leq("#exp", " #act")", exp, act)
#define rk_assert_gt(exp, act)                RKT_ASSERT(RKT_SELFUN(eq, exp), RKTF_GT, "assert_gt("#exp", " #act")", exp, act)
#define rk_assert_geq(exp, act)               RKT_ASSERT(RKT_SELFUN(neq, exp), RKTF_GEQ, "assert_geq("#exp", " #act")", exp, act)
#define rk_assert_inrange(val, low, high)     RKT_ASSERT(RKT_SELFUN(inrange, val), RKTF_INRANGE, "assert_inrange(" #val ", " #low", " #high ")", val, low, high)
#define rk_assert_floateq_tol(exp, act, tol)  RKT_ASSERT(RKT_SELFUN_TOL(toleq, exp), RKTF_TOLEQ, "assert_floateq_tol("#exp", " #act ", " #tol ")", exp, act, tol)
#define rk_assert_floatneq_tol(exp, act, tol) RKT_ASSERT(RKT_SELFUN_TOL(tolneq, exp), RKTF_TOLNEQ,  "assert_floatneq_tol("#exp", " #act ", " #tol ")", exp, act, tol)
#define rk_assert_streq(str1, str2)           RKT_ASSERT(RKTf_streq, RKTF_STREQ, "assert_streq(" #str1 ", " #str2 ")", str1, str2)
#define rk_assert_strneq(str1, str2)          RKT_ASSERT(RKTf_strneq, RKTF_STRNEQ,"assert_strneq(" #str1 ", " #str2 ")", str1, str2)  
#define rk_assert_streq_n(str1, str2, len)    RKT_ASSERT(RKTf_streq_n, RKTF_STREQ, "assert_streq(" #str1 ", " #str2 ", " #len")", str1, str2, len)
#define rk_assert_strneq_n(str1, str2,len)    RKT_ASSERT(RKTf_strneq_n, RKTF_STRNEQ,"assert_strneq(" #str1 ", " #str2 ", " #len")", str1, str2, len)  
#define rk_assert_stdouteq(errstr, len)       RKT_ASSERT(RKTf_streameq, RKTF_STDOUTEQ, "assert_stdouteq(" #errstr ")", RK_OUTPUTSTREAMS_STDOUT, errstr, len)
#define rk_assert_stdoutneq(errstr, len)      RKT_ASSERT(RKTf_streamneq, RKTF_STDOUTNEQ, "assert_stdoutneq(" #errstr ")", RK_OUTPUTSTREAMS_STDOUT, errstr, len)
#define rk_assert_stderreq(errstr, len)       RKT_ASSERT(RKTf_streameq, RKTF_STDERREQ, "assert_stderreq(" #errstr ")", RK_OUTPUTSTREAMS_STDERR, errstr, len)
#define rk_assert_stderrneq(errstr, len)      RKT_ASSERT(RKTf_streamneq, RKTF_STDERRNEQ, "assert_stderrneq(" #errstr ")", RK_OUTPUTSTREAMS_STDERR, errstr, len)

#define AE(TYP, FUN, FUNENUM, EXPRSTR, ...) RKT_CONCAT(RKT, TYP)(FUN,FUNENUM, RKT_CONCAT(TYP, EXPRSTR), __VA_ARGS__)
// clang-format on
