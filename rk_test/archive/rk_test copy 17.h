...
int main(int argc, char** argv) {
    ...
    (void)argc, (void)(argv);
    // char* suites[]={"arena"};
    // RK_RUN_TESTS(suites,countof(suites),.timeout_ms=10);
    // char* suites2[]={"vec"};
    // RK_RUN_TESTS(suites2,countof(suites2),.custom_paths[1] =
    // "ERRFILE.txt",.timeout_ms=10);
    ...
    120-150 ms
    */
    // RK_RUN_TESTS(argv+1,argc-1,.custom_paths[1] =
    // "ERRFILE.txt",.timeout_ms=10);
}
